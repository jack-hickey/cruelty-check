...
Localizer.EMPTY_SEARCH_DESC = `Nothing could be found matching '<span id="lblSearchTerm" class="fw-semibold"></span>'. If you'd like, you can <chip-button variation="info-tertiary" class="btn--add-product" button-style="inline">add a new product</chip-button> and your addition will be reviewed.`;
Localizer.SEARCH_RESULT_CAPTION = `Can't find what you're looking for? Feel free to <chip-button variation="info-tertiary" class="btn--add-product" button-style="inline">add a new product</chip-button>.`;

Localizer.ADD_PRODUCT_TITLE = "New product";
...
Localizer.FEEDBACK_DETAILS_LABEL = "Tell us more";
Localizer.FEEDBACK_DETAILS_VALIDATION_REQUIRED = "Please tell us a bit more so we understand your feedback";

Localizer.FEEDBACK_BUG_GROUP = "Having a problem?";
Localizer.FEEDBACK_IMPROVEMENT_GROUP = "Got an idea?";
Localizer.FEEDBACK_CHAT_GROUP = "Just want to say something";

Localizer.FEEDBACK_BUG_LABEL = "Something's not working";
Localizer.FEEDBACK_MISSING_PRODUCT_LABEL = "I couldn't find a product";
Localizer.FEEDBACK_INCORRECT_INFORMATION_LABEL = "Product info is wrong";
Localizer.FEEDBACK_FEATURE_LABEL = "I've got an idea";
Localizer.FEEDBACK_IMPROVEMENT_LABEL = "Suggestion for improvement";
Localizer.FEEDBACK_THANKS_LABEL = "Just saying thanks!";

Localizer.FEEDBACK_SUCCESS_TITLE = "Feedback sent";
